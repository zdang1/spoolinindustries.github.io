...
async function initContentEditor() {
  // #region agent log
  fetch('http://127.0.0.1:7243/ingest/5f4ec72d-ca00-4592-8679-29f4832c95bd',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({location:'content-editor.js:144',message:'initContentEditor called',data:{hasFirebase:typeof firebase !== 'undefined',hasFirebaseAuth:typeof firebase !== 'undefined' && !!firebase.auth,hasWindowFirebaseAuth:!!window.firebaseAuth,hasWindowFirebaseDb:!!window.firebaseDb},timestamp:Date.now(),sessionId:'debug-session',runId:'run1',hypothesisId:'H3,H4,H5'})}).catch(()=>{});
  // #endregion
  ...
  if (typeof firebase === 'undefined' || !firebase.auth) {
    ...
    // #region agent log
    fetch('http://127.0.0.1:7243/ingest/5f4ec72d-ca00-4592-8679-29f4832c95bd',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({location:'content-editor.js:147',message:'Firebase not loaded - exiting initContentEditor',data:{hasFirebase:typeof firebase !== 'undefined'},timestamp:Date.now(),sessionId:'debug-session',runId:'run1',hypothesisId:'H4,H5'})}).catch(()=>{});
    // #endregion
    return;
  }
  ...
  // #region agent log
  fetch('http://127.0.0.1:7243/ingest/5f4ec72d-ca00-4592-8679-29f4832c95bd',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({location:'content-editor.js:153',message:'After wait - checking Firebase state',data:{hasFirebaseDb:!!window.firebaseDb,hasFirebaseAuth:!!window.firebaseAuth,hasFirebase:typeof firebase !== 'undefined'},timestamp:Date.now(),sessionId:'debug-session',runId:'run1',hypothesisId:'H4,H5'})}).catch(()=>{});
  // #endregion
